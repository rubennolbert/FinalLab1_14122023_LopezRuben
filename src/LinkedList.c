 ...
 */
LinkedList* ll_newLinkedList(void) //nueva cabeza
{
 ...
 *
 */
Node* test_getNode(LinkedList* this, int nodeIndex)  //no tocar(?)
{
 ...
 *
 */
static int addNode(LinkedList* this, int nodeIndex,void* pElement) //no lo se rick(?)
{
    int returnAux = -1;
    Node* pNodeNew = NULL;
    Node* pNodePrevius = NULL;
    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    {
    	...
    	if(pNodeNew != NULL)
    	{
    		...
    		{
    			pNodePrevius = getNode(this, nodeIndex-1);
    			if(pNodePrevius != NULL)
    			{
    				pNodeNew->pNextNode = pNodePrevius->pNextNode;
					pNodePrevius->pNextNode = pNodeNew;
    			}
 ...
 *
 */
int test_addNode(LinkedList* this, int nodeIndex,void* pElement) //no tocas(?)
{
...
/** \brief Permite realizar el test de la funcion addNode la cual es privada //es un getter de pElement
 *
 * \param this LinkedList* Puntero a la lista
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >=0 && index <ll_len(this))
    {
    	if(index == 0)
    	{
    		this->pFirstNode = this->pFirstNode->pNextNode; //enlaza al siguiente, si no hya nada NULL
    	}
    	else
    	{
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
    	...
    	for(int i=0; i<ll_len(this2); i++)
    	{
    		...
    		if( 0 == ll_contains(this, auxElement))
    		{
    			returnAux = 0;
    		}
    	}
